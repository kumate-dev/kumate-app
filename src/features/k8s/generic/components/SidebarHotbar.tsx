  ...
  return (
    ...
    >
      ...
      <div className="mt-auto flex items-center justify-center px-0">
        <button
          className="group flex h-9 w-9 items-center justify-center rounded-full border border-white/20 bg-white/5 text-xs text-white/80 hover:bg-white/10 hover:text-white"
          onClick={() => {
            const next = !expanded;
            onExpandChange?.(next);
          }}
