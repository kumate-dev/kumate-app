...
import { listReplicaSets, listNamespaces } from "../../services/k8s";
  ...
  useEffect(() => {
    ...
    async function fetch() {
      ...
      try {
        ...
        const res = await withTimeout(listReplicaSets({ name: context.name, namespace: nsParam }), 15000);
        ...
        <Table>
          ...
          <Tbody>
            ...
            {!loading && filtered.length === 0 && (
              <Tr><Td colSpan={5} className="text-white/60">No replicasets</Td></Tr>
            )}
