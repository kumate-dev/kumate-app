...
import { listCronJobs, listNamespaces } from "../../services/k8s";
import { relativeAge } from "../../utils/time";
import { suspendVariant } from "../../utils/k8s";
import { useNamespaceStore } from "../../state/namespaceStore";

export default function PaneCronJob({ context }) {
  ...
  useEffect(() => {
    ...
    async function fetch() {
      ...
      try {
        ...
        const res = await withTimeout(listCronJobs({ name: context.name, namespace: nsParam }), 15000);
