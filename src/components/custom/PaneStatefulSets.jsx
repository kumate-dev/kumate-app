...
import { listStatefulSets, listNamespaces } from "../../services/k8s";
import { relativeAge } from "../../utils/time";
import { readyVariant } from "../../utils/k8s";
import { useNamespaceStore } from "../../state/namespaceStore";


export default function PaneStatefulSets({ context }) {
  ...
  useEffect(() => {
    ...
    async function fetch() {
      ...
      try {
        ...
        const res = await withTimeout(listStatefulSets({ name: context.name, namespace: nsParam }), 15000);
        ...
        <Table>
          ...
          <Tbody>
            ...
            {!loading && filtered.length === 0 && (
              <Tr><Td colSpan={5} className="text-white/60">No statefulsets</Td></Tr>
            )}
